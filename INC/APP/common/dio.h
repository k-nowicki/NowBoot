 ...
 *
 * \file dio.h
 *\brief Obsluga wejsc/wyjsc cyfrowych urzadzenia -makra.
 *
 * <br/>
 * (nazewnictwo zaciagniete ze schematow urzadzenia).<br/>
 * Rowniez Globalny rejestr stanu IO
 * @par
 * @author Karnell worker
 * © 2010 KARNELL®
 * @date 25-10-2010
 * @version v1.1
 *
...
///Struktura przechowujaca stany wejsc i wyjsc
typedef struct{
	u32 OUT;	///< wyjscia
	u32 IN;		///< wejscia
...
///Globalny rejestr stanu wejsc i wyjsc
extern DIOs Dio;
